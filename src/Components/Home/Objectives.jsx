...
function Objectives() {
  return (
    <HeroHighlight className='w-[90%] h-[80%] justify-between space-x-8 flex flex-col md:flex-row'>
        ...
        <BackgroundGradient className='rounded-[22px]  p-9 text-justify bg-white dark:bg-zinc-900 text-white'>
